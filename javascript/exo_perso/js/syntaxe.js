...
moi.unshift(date);
console.log(moi);
// 2- retirer et sauvgarder le nom et l'adresse mail et remplacer les par <br>
//  votre adresse postale et votre mot de passe.
...
// 5- Parcourir le tableau (utiliser la boucle "for", la syntaxe "moi.length" et
// très utile dans cette étape) et aficher les informations à la fois sur le navigateur
//  et à partir de la console
...
// description de la fonction splice : à partir du troisième paramètre ce
// qu'on ajoute comme valeur ça sera inséré à partir la position précisée dans le premier paramètre
